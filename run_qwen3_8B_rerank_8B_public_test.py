...
COLLECTION = "articles_nvloc_8b"
QDRANT_PORT = 16333
TOP_K = 10
DEVICE = "cuda:5"
DEVICE2= "cuda:6"
OUTPUT_CSV = f"Qwen8B_rerank8B_{TOP_K}_article_ids.csv"
INSTRUCTION = (
...
encoder = SentenceTransformer("Qwen/Qwen3-Embedding-8B", device=DEVICE)
...
model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen3-Reranker-8B").to(DEVICE2).eval()
